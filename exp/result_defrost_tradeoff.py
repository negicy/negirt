...
result_plot_acc_var_onepl(threshold, result_acc_dic, ay='accuracy', bbox=(0.150, 0.850)).show()
...
result_plot_acc_var(threshold, result_acc_dic, ay='accuracy', bbox=(0.150, 0.850)).show()
